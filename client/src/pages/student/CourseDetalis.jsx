  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        {/* left column */}
        <div className="z-2 max-w-xl text-gray-500">
          <h1 className="md:text-[36px] md:leading-[44px] sm:text-[26px] sm:leading-[36px] font-semibold text-gray-800">
              ...
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm md:text-gray-900">
                      ...
                      {chapter.chapterContent.map((lecture, i) => (
                        <li className="flex items-center gap-2 py-1" key={i}>
                          <img
                            ...
                            alt="play_icon"
                          />
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-gray-900">
        ...
        {/* right column */}
        <div className="z-10 course-card custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-red-500">
                {" "}
                <span className="font-medium">5 days</span> 5 days left at this
                price!
              </p>
            </div>
